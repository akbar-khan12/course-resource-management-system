...
function Adminassign({ courseId }) {
  ...
  const uploadFile = () => {
    ...
    const fileRef = ref(storage, `courses/${id}/assignments/${fileUpload.name + v4()}`);
...
// console.log(courseId);
  ...
  const uploadTextFile = () => {
    ...
    const textFileRef = ref(storage, `courses/${id}/assignments/${fileName}`);
